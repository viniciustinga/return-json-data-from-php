...
<head>
	<meta charset="utf-8">
	<title>Return JSON Data from PHP Script using Ajax Jquery</title>
...
<body>
	...
	<div class="container" style="width: 900px;">
		<h2 align="center">Return JSON Data from PHP Script using Ajax Jquery</h2>
...
$(document).ready(function(){
	$('#search').click(function(){
		...
		// check to see if id is not equal to blank
		if(id != '')
		{
			$.ajax({
				url: "fetch.php",
				...
				{
					// display employee data into html table
